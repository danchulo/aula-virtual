...
?>
					...
					<div class="control-group">
								...
								<div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
												<input  type="button" onclick="grabar('../../Controlador','EstuControlador.php','14','7','MiAjax')" class="btn btn-info" value="Guardar">
	<input  type="button" onclick="consultaSimple('../../Controlador','EstuControlador.php','7','MiAjax')" class="btn btn-success" value="Cancelar">
