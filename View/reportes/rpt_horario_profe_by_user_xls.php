...
header("Content-Disposition: attachment;filename=reporte_horario_profesor.xls");

$objBean=new HorarioProfeBean();
$listaHorario= $_SESSION['listaHoraProfe'];
...
$html='<html>
    ...
    <body>
  <center>
  <h1>Institución Educativa Particular Carl Palmer</h1>
    <p> Horario Actual del Profesor:<b> '.$profe_nom.' ('.$año.')</b></p> 
</center>                  
